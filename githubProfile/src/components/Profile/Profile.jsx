...
export default function Profile() {
  let data = useStore((set) => set.data);
  let repo = useStore((set) => set.repo);
  ...
  return (
    <div className="bg-gray-800 md:w-full">
      <header className="w-full flex flex-col justify-center items-center">
        ...
        <div className="hidden md:w-full md:flex mt-2 justify-center gap-16 pl-36 items-start">
          ...
          {loading ? (
            ...
            <div className="bg-black w-1/3 p-4 flex justify-center gap-5 rounded-lg">
      ...
      <section className="mt-24 flex w-full flex-col gap-8 items-center justify-center md:hidden">
        ...
        <div className="p-3 flex flex-col gap-3 justify-center items-center md:flex-row md:justify-center md:p-0 md:gap-8 md:flex-wrap">
          {loading
            ? Array.from(new Array(4)).map((_, index) => (
                <Skeleton key={index} variant="rectangular" width={300} height={150} />
              ))
            : mostrarTodos
            ? repo &&
